...
/**
 * @ngdoc object
 * @name lbServices.Boost
 * @header lbServices.Boost
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Boost` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Boost#status
         * @methodOf lbServices.Boost
         *
         * @description
         *
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Boost` object.)
         * </em>
         */
        "status": {
          url: urlBase + "/boost/status",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Boost#boostWater
         * @methodOf lbServices.Boost
         *
         * @description
         *
         * Boost the water for a number of minutes
         *
         * @param {Object=} parameters Request parameters.
         *
         *   This method does not accept any parameters.
         ...
         */
        "boostWater": {
          url: urlBase + "/boost/water",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Boost#boostHeating
         * @methodOf lbServices.Boost
         *
         * @description
         *
         * Boost the heating for a number of minutes
         *
         * @param {Object=} parameters Request parameters.
         *
         *   This method does not accept any parameters.
         ...
         */
        "boostHeating": {
          url: urlBase + "/boost/heating",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Boost#cancelHeating
         * @methodOf lbServices.Boost
         *
         * @description
         *
         * Cancel all current heating boosts
         *
         * @param {Object=} parameters Request parameters.
         *
         *   This method does not accept any parameters.
         ...
         */
        "cancelHeating": {
          url: urlBase + "/boost/heating/cancel",
          method: "DELETE"
        },

        /**
         * @ngdoc method
         * @name lbServices.Boost#cancelWater
         * @methodOf lbServices.Boost
         *
         * @description
         *
         * Cancel all current water boosts
         *
         * @param {Object=} parameters Request parameters.
         *
         *   This method does not accept any parameters.
         ...
         */
        "cancelWater": {
          url: urlBase + "/boost/water/cancel",
          method: "DELETE"
        },
      }
    );
    ...
    /**
    * @ngdoc property
    * @name lbServices.Boost#modelName
    * @propertyOf lbServices.Boost
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Boost`.
    */
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Users#mosquittoLogin
         * @methodOf lbServices.Users
         *
         * @description
         *
         ...
         */
        "mosquittoLogin": {
          url: urlBase + "/users/mosquitto/login",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Users#mosquittoAcl
         * @methodOf lbServices.Users
         *
         * @description
         *
         ...
         */
        "mosquittoAcl": {
          url: urlBase + "/users/mosquitto/acl",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Users#mosquittoSuperuser
         * @methodOf lbServices.Users
         *
         * @description
         *
         ...
         */
        "mosquittoSuperuser": {
          url: urlBase + "/users/mosquitto/superuser",
          method: "POST"
        },
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Sensor.readings.findById() instead.
        "prototype$__findById__readings": {
          url: urlBase + "/sensors/:id/readings/:fk",
          method: "GET"
        },

        // INTERNAL. Use Sensor.readings.destroyById() instead.
        "prototype$__destroyById__readings": {
          url: urlBase + "/sensors/:id/readings/:fk",
          method: "DELETE"
        },

        // INTERNAL. Use Sensor.readings.updateById() instead.
        "prototype$__updateById__readings": {
          url: urlBase + "/sensors/:id/readings/:fk",
          method: "PUT"
        },

        // INTERNAL. Use Sensor.readings() instead.
        "prototype$__get__readings": {
          isArray: true,
          url: urlBase + "/sensors/:id/readings",
          method: "GET"
        },

        // INTERNAL. Use Sensor.readings.create() instead.
        "prototype$__create__readings": {
          url: urlBase + "/sensors/:id/readings",
          method: "POST"
        },

        // INTERNAL. Use Sensor.readings.destroyAll() instead.
        "prototype$__delete__readings": {
          url: urlBase + "/sensors/:id/readings",
          method: "DELETE"
        },

        // INTERNAL. Use Sensor.readings.count() instead.
        "prototype$__count__readings": {
          url: urlBase + "/sensors/:id/readings/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use Reading.sensor() instead.
        "::get::reading::sensor": {
          url: urlBase + "/readings/:id/sensor",
          method: "GET"
        },
      }
    );
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Sensor.readings
     * @header lbServices.Sensor.readings
     * @object
     * @description
     *
     * The object `Sensor.readings` groups methods
     * manipulating `Reading` instances related to `Sensor`.
     *
     * Call {@link lbServices.Sensor#readings Sensor.readings()}
     ...
     */
        ...
        R.readings = function() {
          ...
          var action = TargetResource["::get::sensor::readings"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Sensor.readings#count
         * @methodOf lbServices.Sensor.readings
         *
         * @description
         *
         * Counts readings of sensor.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.readings.count = function() {
          var TargetResource = $injector.get("Reading");
          var action = TargetResource["::count::sensor::readings"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Sensor.readings#create
         * @methodOf lbServices.Sensor.readings
         *
         * @description
         *
        ...
        R.readings.create = function() {
          var TargetResource = $injector.get("Reading");
          var action = TargetResource["::create::sensor::readings"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Sensor.readings#destroyAll
         * @methodOf lbServices.Sensor.readings
         *
         * @description
         *
        ...
        R.readings.destroyAll = function() {
          var TargetResource = $injector.get("Reading");
          var action = TargetResource["::delete::sensor::readings"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Sensor.readings#destroyById
         * @methodOf lbServices.Sensor.readings
         *
         * @description
         *
        ...
        R.readings.destroyById = function() {
          var TargetResource = $injector.get("Reading");
          var action = TargetResource["::destroyById::sensor::readings"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Sensor.readings#findById
         * @methodOf lbServices.Sensor.readings
         *
         * @description
         *
        ...
        R.readings.findById = function() {
          var TargetResource = $injector.get("Reading");
          var action = TargetResource["::findById::sensor::readings"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Sensor.readings#updateById
         * @methodOf lbServices.Sensor.readings
         *
         * @description
         *
        ...
        R.readings.updateById = function() {
          var TargetResource = $injector.get("Reading");
          var action = TargetResource["::updateById::sensor::readings"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Sensor.readings.findById() instead.
        "::findById::sensor::readings": {
          url: urlBase + "/sensors/:id/readings/:fk",
          method: "GET"
        },

        // INTERNAL. Use Sensor.readings.destroyById() instead.
        "::destroyById::sensor::readings": {
          url: urlBase + "/sensors/:id/readings/:fk",
          method: "DELETE"
        },

        // INTERNAL. Use Sensor.readings.updateById() instead.
        "::updateById::sensor::readings": {
          url: urlBase + "/sensors/:id/readings/:fk",
          method: "PUT"
        },
    ...
    */
    R.modelName = "Reading";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Reading#sensor
         * @methodOf lbServices.Reading
         *
         * @description
         *
        ...
        R.sensor = function() {
          ...
          var action = TargetResource["::get::reading::sensor"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.Switch
 * @header lbServices.Switch
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Switch` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Switch#create
         * @methodOf lbServices.Switch
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Switch` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/switches",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Switch#upsert
         * @methodOf lbServices.Switch
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/switches/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Switch#findById
         * @methodOf lbServices.Switch
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/switches/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Switch#find
         * @methodOf lbServices.Switch
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Switch#findOne
         * @methodOf lbServices.Switch
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/switches/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Switch#updateAll
         * @methodOf lbServices.Switch
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/switches/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Switch#deleteById
         * @methodOf lbServices.Switch
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/switches/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Switch#prototype$updateAttributes
         * @methodOf lbServices.Switch
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Switch#sendOn
         * @methodOf lbServices.Switch
         *
         * @description
         *
         * Sends the on command to this switch
         *
         * @param {Object=} parameters Request parameters.
         *
         *   This method does not accept any parameters.
         ...
         */
        "sendOn": {
          url: urlBase + "/switches/:id/on",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Switch#sendOff
         * @methodOf lbServices.Switch
         *
         * @description
         *
         * Sends the off command to this switch
         *
         * @param {Object=} parameters Request parameters.
         *
         *   This method does not accept any parameters.
        ...
        /**
         * @ngdoc method
         * @name lbServices.Switch#updateOrCreate
         * @methodOf lbServices.Switch
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Switch#destroyById
         * @methodOf lbServices.Switch
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Switch#removeById
         * @methodOf lbServices.Switch
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Switch#modelName
    * @propertyOf lbServices.Switch
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Switch`.
    */
